...
class HomePageScreen extends ConsumerStatefulWidget {
  ...
  static const String routeUrl = "/homepage";
...
class _HomePageState extends ConsumerState<HomePageScreen> {
  ...
  ListView cookDataList() {
    return ListView.separated(
        shrinkWrap: true,
        primary: false,
        itemBuilder: (context, index) {
          var cookdata = cookModel.cookDataModel.cookDataDetailModel[index];
          return Container(
            padding: const EdgeInsets.all(16),
        ...
        itemCount: cookModel.cookDataModel.cookDataDetailModel.length);
  }
